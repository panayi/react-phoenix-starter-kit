defmodule Api.V1.UserController do
  ...
  plug Guardian.Plug.EnsureAuthenticated, on_failure: { Api.V1.SessionController, :unauthenticated_api }
  ...
  def current_user(conn, %{"jwt" => jwt}) do
    case Guardian.Plug.current_resource(conn) do
      nil ->
        ...
        |> render(Api.V1.SessionView, "error.json", error: "User not found")
      user ->
        conn
        |> put_status(:ok)
        |> render("show.json", user: user)
